...
<head>
    ...
    <style>
        ...
        * {
        ...
        .highlight-blue { color: var(--secondary-color); font-weight: 600; }
        .highlight-orange { color: var(--accent-color); font-weight: 600; }
        ...
        /* Estilo Gold Metálico para Framework 4 Step 4 */
        .gold-step {
        ...
        @media (max-width: 900px) {
            ...
            h1 { font-size: 1.9rem; line-height: 1.1; margin-top: 30px; }
...
<body>
    ...
    <div class="container">
        ...
        <section id="f1">
            ...
            <h2>Case G4 Redução de CAC</h2>
            <p>O G4 não vende aulas. Eles vendem um <span class="highlight-blue">Framework de Execução</span>. A autoridade da marca é tão forte que os empresários buscam o G4 de forma ativa e fiel.</p>
            ...
            <div style="margin-top: 40px;">
                <h2>Case G4 Valor e Sustentabilidade</h2>
                ...
                <div class="application-box">
                    <p>Ao posicionar a ATM como a <span class="highlight-orange">Engenharia de Performance</span> do setor, paramos de atrair o curioso que busca o cursinho mais barato e passamos a atrair o Visionário que entende que o lucro está no método. Isso protege sua margem e torna seu conhecimento um ativo que valoriza com o tempo.</p>
                </div>
            </div>

            <div class="image-wrapper">
                <div class="img-tag">IMG_01</div>
                <img src="img/img1.jpg" class="parallax-img" alt="Modelo Equity G4">
            </div>
        ...
        <section id="f2">
            ...
            <div class="image-wrapper" style="border: none; background: transparent;">
                ...
                <img src="img/img2.jpg" class="parallax-img" alt="6 Pilares ATM">
            </div>
        </section>
        ...
        <section id="f3">
            ...
            <p>É o ponto de validação. É onde identificamos quem são os <span class="highlight-blue">10% de alunos</span> com potencial para as mentorias Premium.</p>

            <div class="image-wrapper">
                <div class="img-tag">IMG_03</div>
                <img src="img/img3.jpg" class="parallax-img" alt="Radar Operacional">
            </div>
        ...
        <section id="f4">
            ...
            <div class="ladder-container">
                ...
                <div class="ladder-row gold-step">
                    <div class="row-content">
                        <h3 class="gold-text">Design e IA Avançada</h3>
                        <p>O ápice da tecnologia e automação de processos.</p>
                    </div>
                    <span class="row-id" style="color: #bf953f;">04</span>
                </div>
            </div>

            <div class="image-wrapper">
                <div class="img-tag">IMG_04</div>
                <img src="img/img4.jpg" class="parallax-img" alt="Infográfico Escada">
            </div>
        </section>
        ...
        <section id="f5">
            ...
            <div class="image-wrapper">
                ...
                <img src="img/img5.jpg" class="parallax-img" alt="Fluxograma Domínio">
            </div>
        ...
        <section id="f6" style="border-bottom: none;">
            ...
            <div class="equity-visual">
                <div class="equity-bar-group">
                    <span class="bar-label">baseado apenas em esforço físico</span>
                    <div class="bar-track">
                        <div class="bar-fill" style="width: 20%;">20% EQUITY</div>
                    </div>
                </div>
                <div class="equity-bar-group">
                    <span class="bar-label">baseado em Método e Recorrência</span>
                    <div class="bar-track">
            ...
            <div class="image-wrapper">
                ...
                <img src="img/img6.jpg" class="parallax-img" alt="Equity Comparison">
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-top: 40px;">
                ...
                <div>
                    <h3 style="color: var(--accent-color); font-size: 0.75rem; text-transform: uppercase; margin-bottom: 10px; font-family: var(--font-mono);">Receita Recorrente LTV</h3>
            ...
            <div class="image-wrapper" style="margin-top: 80px;">
                ...
                <img src="img/img7.jpg" class="parallax-img" alt="Final Journey">
            </div>
